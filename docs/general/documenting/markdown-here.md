...
[Относительная ссылка на документ](../articles/naming-conventions.md)
...
Внутри строки:
![alt-текст](images/markdown-here.png "Текст заголовка логотипа 1")

В сноске:
![alt-текст][logo]

[logo]: images/markdown-here.png "Текст заголовка логотипа 2"
```
